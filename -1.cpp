...
int main() {
    ...
    if(wealth <= 0) {
        printCenteredBox("ERROR: Wealth must be greater than 0");
        return 0;
    }
    ...
    while(gender < 1 || gender > 2) {
        printf("Invalid choice! Try Again (1 or 2): ");
        scanf("%d", &gender);
    }
    ...
    if(gender == 1) {
        ...
        if(spouse == 1) {
            ...
            while(nSpouse < 1 || nSpouse > 4) {
                printf("Number of wives should be between 1-4. Try again: ");
                scanf("%d", &nSpouse);
            }
            totalHeirs++;
        } else {
    ...
    if(fixedShares > wealth) {
        ...
        if(remaining > 0) {
            if(son > 0) {
                ...
                printf("Sons and daughters share residue: %d\n", remaining);
                ...
                printf("Father gets remaining residue: %d\n", remaining);
                ...
                printf("Paternal grandfather gets remaining residue: %d\n", remaining);
            }
                ...
                if(totalParts > 0) {
                    ...
                    printf("Full siblings share residue: %d\n", remaining);
                    if(brotherFull > 0) {
                ...
                printf("Paternal uncles get remaining residue: %d\n", remaining);
            }
            else if(daughter > 0 && son == 0 && father == 2 && paternalGrandfather == 2 && nSiblings == 0) {
                printf("No residuary heirs found. Residue returns to daughters: %d\n", remaining);
