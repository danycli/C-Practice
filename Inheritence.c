// Distribution of Inheritence according to Islamic Sharia.
...
void printSectionHeader(char title[]) {
    printf("\n");
    int msgLen = strlen(title);
    int totalSpaces = (CONSOLE_WIDTH - msgLen - 8) / 2;
...
void printPrompt(const char question[]) {
    ...
    for (int i = 0; i < sideSpaces; i++) printf(" ");
    printf("║  %s", question);
    for (int i = 0; i < boxWidth - 6 - qLen; i++) printf(" ");
    printf("  ║\n");
...
int main() {
        ...
        if(remaining > 0) {
            if(son > 0) {
                ...
                printResidueDistribution("Sons and daughters share residue", remaining, 
                    ...
                    //Green
                printf("    Each son gets: \033[1;32m%.2f\033[33m (Total for %d sons: \033[1;32m%.2f\033[33m)\n", 
                        sonPart, son, sonPart * son);
                if(daughter > 0) {
                    printf("    Each daughter gets: \033[1;32m%.2f\033[33m additional (Total for %d daughters: \033[1;32m%.2f\033[33m)\n", 
    ...
    printf("Maternal grandmother's total: %.2f (fixed) + %.2f (residue) = \033[1;32m%.2f\033[0m\n",
    ...
    printf("Each uterine sibling gets: \033[1;32m%.2f\033[0m\n", eachShare + uterineShare/totalUterine);
}
    ...
    printf("Mother's total share: %.2f (fixed) + %.2f (residue) = \033[1;32m%.2f\033[0m\n",
    ...
    printf("Husband's total share: %.2f (fixed) + %.2f (residue) = \033[1;32m%.2f\033[0m\n",
    ...
    if(nSpouse == 1) {
        printf("Wife's total share: %.2f (fixed) + %.2f (residue) = \033[1;32m%.2f\033[0m\n",
               wifeShare, remaining, wifeShare + remaining);
    } else {
        printf("Total wives' share: %.2f (fixed) + %.2f (residue) = \033[1;32m%.2f\033[0m\n",
               wifeShare, remaining, wifeShare + remaining);
        printf("Each wife gets: \033[1;32m%.2f\033[0m\n", (wifeShare + remaining) / nSpouse);
    }
}
                ...
                printf("Father's total share: %.2f (1/6) + %.2f (residue) = \033[1;32m%.2f\033[33m\n", 
                ...
                if(totalParts > 0) {
                    ...
                    if(brotherFull > 0) {
                        printf("    Each full brother gets: \033[1;32m%.2f\033[33m (Total: \033[1;32m%.2f\033[33m)\n", 
                                brotherPart, brotherPart * brotherFull);
                    }
                    if(sisterFull > 0) {
                        printf("    Each full sister gets: \033[1;32m%.2f\033[33m (Total: \033[1;32m%.2f\033[33m)\n", 
    ...
    if (sisterFull == 1) {
        ...
        printf("Full sister's share: \033[1;32m%.2f\033[0m\n", sisterShare);
    } else {
        ...
        printf("Each sister gets: \033[1;32m%.2f\033[0m (Total: \033[1;32m%.2f\033[0m)\n", each, totalShare);
    }
}
    ...
    printf("Each paternal uncle gets: \033[1;32m%.2f\033[0m (Total for %d uncles: \033[1;32m%.2f\033[0m)\n",
    ...
    printf("Each daughter gets additional: \033[1;32m%.2f\033[0m\n", remaining / daughter);
}
