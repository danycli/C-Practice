...
int main() {
    ...
    printf("Mother's total share: %.2f (fixed) + %.2f (residue) = \033[1;32m%.2f\033[33m\n",
    ...
    if (sisterFull == 1) {
        ...
        printf("Full sister's share: \033[1;32m%.2f\033[33m\n", sisterShare);
    } else {
        ...
        printf("Each sister gets: \033[1;32m%.2f\033[33m (Total: \033[1;32m%.2f\033[33m)\n", each, totalShare);
    }
}
    ...
    printf("Each paternal uncle gets: \033[1;32m%.2f\033[33m (Total for %d uncles: \033[1;32m%.2f\033[33m)\n",
    ...
    printf("Each daughter gets additional: \033[1;32m%.2f\033[33m\n", remaining / daughter);
}
